        ...
        response =
          {
            ...response,
            status: failed ? 'failed' : 'success',
            message: failed ? 'Failed to deploy remote tokens' : 'Deploy remote tokens successful',
            receipt,
          }
      } catch (error) {
        response =
        ...
        response =
          {
            ...response,
            status: failed ? 'failed' : 'success',
            message: failed ? `Failed to register origin token${register_only ? '' : ' and deploy remote tokens'}` : `Register origin token${register_only ? '' : ' and deploy remote tokens'} successful`,
            receipt,
          }
      } catch (error) {
        response =
