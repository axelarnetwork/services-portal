...
const chainConfigs = [
  ...
  {...avalancheFuji, networkNameOnAxelar: "avalanche", environment: "testnet"},
  ...
  {...arbitrumGoerli, networkNameOnAxelar: "arbitrum", environment: "testnet"},
];

export const getWagmiChains = () => chainConfigs;

console.log("WagmiConfigProvider chainConfigs",chainConfigs);
